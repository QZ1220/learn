...
```
native方法我们怎么去看它的实现呢？以查看findLoadedClass0方法为例，可以在http://hg.openjdk.java.net/jdk8u/jdk8u/jdk/file/b860bcc84d51/src/share/native/java/lang/ClassLoader.c中搜索：JVM_FindLoadedClass即可看到。
