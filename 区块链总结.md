...
CommitTransactionSpent()方法，入参wtxNew就是CreateTransaction()函数生成的新的交易。
```java
...
=====
  ...
  [7]: https://github.com/WQZ321123/learn/blob/master/image/bitcoin/transactionII.png?raw=true